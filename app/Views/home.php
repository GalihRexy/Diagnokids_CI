	  ...
	  <div class="container">
		 ...
		 <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    <ul class="navbar-nav ml-auto align-self-center">
		      <li class="nav-item">
		        <a class="nav-link mt-1 active" href="<?= base_url('home'); ?>">Home</a>
		      </li>
		      <li class="nav-item">
	...
	<section class="container mt-2" id="hero">
		<div class="row">
			<div class="col align-self-center">
				...
				<button class="btn-hero mt-2"><a href="<?= base_url('diagnosa') ?>" style="text-decoration: none; color: #fff;">Mulai Periksa</a></button>
			</div>
