	  ...
	  <div class="container">
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    <ul class="navbar-nav ml-auto align-self-center">
		      ...
		      <li class="nav-item">
		        <a class="nav-link mt-1 active" href="<?= base_url('diagnosa') ?>">Diagnosa</a>
		      </li>
		      <li class="nav-item">
		        <a class="nav-link mt-1" href="<?= base_url('data-diagnosa') ?>">Data Diagnosa</a>
		      </li>
				...
				<?php foreach ($anak as $row) { ?>
					<div class="row mb-3 dataAnak2" style="max-width: 400px; margin: 0 auto;">			
			    		...
			    		<div class="col align-self-center">
			    			<h5 class=""><a href="<?= base_url('diagnosa/'.$row['id']); ?>" style="text-decoration: none;color: #232D42;"><?= $row['nama'] ; ?></a></h5>
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form method="post" action="<?= base_url('profile/tambah_data_anak'); ?>">
	        	<?= csrf_field() ?>
